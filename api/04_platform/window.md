...
desc.height     = 720u;
desc.resizable  = true;
desc.windowMode = platform::WindowMode::Windowed;  // or Maximized / BorderlessWindowed / Fullscreen
...
| `windowMode` | `Windowed` | `Windowed` / `Maximized` / `BorderlessWindowed` / `Fullscreen` |
| `vsync` | `true` | Present synchronization preference |
